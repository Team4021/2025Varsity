...
public class rightCoralReefTrack extends Command {
  ...
  public rightCoralReefTrack(Vision m_vision) {
  ...
  public void calculateAlignment() {
    aprilTagAlignment =
        alignedPID.calculate(
            m_vision.getTargetX(0).getRadians(), m_vision.calculateRightCoralOffsetX());
    VisionConstants.AlignmentConstants.aprilTagAlignmentX =
        (-aprilTagAlignment * Constants.lastValidTargetAngle.getCos());
    VisionConstants.AlignmentConstants.aprilTagAlignmentY =
        (-aprilTagAlignment * Constants.lastValidTargetAngle.getSin());
  }
